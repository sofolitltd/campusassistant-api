...
func (h *GenericHandler[T]) GetAll(c *gin.Context) {
	...
	// Add filters
	uuidFilters := []string{"university_id", "department_id", "faculty_id", "session_id", "user_id", "uploader_id", "level_id", "course_category_id", "batch_id", "student_profile_id", "organization_id", "skill_id"}
